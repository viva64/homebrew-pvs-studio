...
The PVS-Studio C# analyzer requires .NET Core SDK 3.1 and the PVS-Studio C++ analyzer (pvs-studio) installed on a machine. 
The .NET Core SDK for macOS can be downloaded from [this page](https://dotnet.microsoft.com/download/dotnet-core/3.1).
